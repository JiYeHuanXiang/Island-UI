...
尊敬的用户，欢迎您选择由极夜幻想等研发的海岛骰点核心（Island），在您使用自定义功能前，请务必仔细阅读使用须知，当您使用我们提供的服务时，即代表您已同意使用须知的内容。

  您需了解，海岛核心官方版只支持 TRPG 功能，娱乐功能定制化请自便，和海岛无关。
  您清楚并明白您对通过骰子提供的全部内容负责，包括自定义回复、非自带的插件、牌堆。海岛骰不对非自身提供以外的内容合法性负责。您不得在使用海岛骰服务时，导入包括但不限于以下情形的内容：
  ...
  (11) 散布任何贬损、诋毁、恶意攻击海岛骰及开发人员、海洋馆工作人员、mod 编写人员、关联合作者的；
  (12) 含有中华人民共和国法律、行政法规、政策、上级主管部门下发通知中所禁止的其他内容的。

  一旦查实您有以上禁止行为，请立即停用海岛骰。同时我们也会主动对你进行举报。</pre
    >
